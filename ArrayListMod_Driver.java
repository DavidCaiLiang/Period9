...
if (test) {
  System.out.println("test 4F: Pass");
}
else {
  System.out.println("test 4F: Fail");
}
...
if (test) {
  System.out.println("test 7F: Pass");
}
else {
  System.out.println("test 7F: Fail");
}
//-------------------------------------------------//
//Test 8A
strings.clear();
...
if (i != 0 && i % 6 == 0) {
  ...
  if(!(strings.set(i, "jimmy").equals(i + "tom"))) {
    test = false;
...
if (i != 0 && i % 4 == 0) {
  ...
  if(!(strings.set(i, "dylan").equals("jimmy"))) {
    test = false;
...
if (test) {
  System.out.println("test 9E: Pass");
}
else {
  System.out.println("test 9E: Fail");
}
 }
...
System.out.println("Ordered 3: Fail, 0");
}
try {
if (orderedInts.set(13,11) == 13) {
  test = false;
}
...
System.out.println("Ordered 3: Fail, 3");
}
